...
log_filename = os.path.join(log_dir_path, f"polycl_{os.path.splitext(os.path.basename(config['downstream_dataset']))[0]}_{config['activation']}_lr_{config['lr']}_{config['batch_size']}_nepochs_{config['n_epochs']}.log")
